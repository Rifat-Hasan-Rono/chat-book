<template>
  <div class="form-wrapper">
    ...
    <form>
      ...
      <router-link :to="{name: 'register'}" class="btn btn-outline-light btn-sm">Register now!</router-link>or
      <router-link :to="{name: 'login'}" class="btn btn-outline-light btn-sm">Login!</router-link>
    </form>
    <!-- ./ form -->
  </div>
</template>
